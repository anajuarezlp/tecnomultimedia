function pantallajugando(){
 ...
 x_enemigo -= vel_enemigo; // Mover horizontalmente de derecha a izquierda
  if (x_enemigo < -r_enemigo) {
    x_enemigo = width + r_enemigo + random(50, 100);
    y_enemigo = random(r_enemigo, height - r_enemigo);
